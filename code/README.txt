NeuralNetwork.py contains 
	- all the custom pytorch modules used to create both the MLP and residual networks
	- for both, the general patten is create a linear module, 
		use it to create a "block" with nonlinearity, 
		and finally use both of these to create a full network
